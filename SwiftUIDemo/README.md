...
Moneyoyo Ad SDK Integration Demo with SwiftUI.

### Prerequisites

To run this demo, you need to set up the corresponding app and ad zone on the Moneyoyo website.

1. Create an account on the [Moneyoyo Publisher Website](https://pub.moneyoyo.com/)
